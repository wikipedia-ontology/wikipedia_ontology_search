...
public class ParseTest {
    public static void main(String[] args) {
        ...
        Resource resource = ResourceFactory.createResource(WikipediaOntologyStorage.CLASS_NS + "アナウンサー");
        for (ResIterator i = model.listSubjectsWithProperty(RDF.type, resource); i.hasNext();) {
