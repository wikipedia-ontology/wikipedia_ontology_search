...
WIKIPEDIA_ONTOLOGY_SEARCH.OptionPanel = {
                    ...
                    items : [
                        {
                            ...
                            handler : WIKIPEDIA_ONTOLOGY_SEARCH.OptionPanel.applyNewOptionState
                        },
                        {
                            id : 'expand_all_class',
...
WIKIPEDIA_ONTOLOGY_SEARCH.OptionPanel.applyNewOptionState = function() {
    if (Ext.getDom('show_isa_tree') != null) {
