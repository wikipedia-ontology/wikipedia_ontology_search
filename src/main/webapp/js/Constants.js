...
WIKIPEDIA_ONTOLOGY_SEARCH.constants = {
    ...
    ALL_CLASSES : BASE_SERVER_URL + "ALLClasses.json",
    CLASS_PATH : "class/",
    ...
    BASE_CLASS_URI : BASE_URI + CLASS_PATH,
    BASE_PROPERTY_URI : BASE_URI + PROPERTY_PATH,
    BASE_INSTANCE_URI : BASE_URI + INSTANCE_PATH,
    BASE_SERVER_CLASS_URL : BASE_SERVER_URL + CLASS_PATH,
    BASE_SERVER_CLASS_DATA_URL : BASE_SERVER_CLASS_URL + DATA_PATH,
    BASE_SERVER_PROPERTY_URL : BASE_SERVER_URL + PROPERTY_PATH,
    BASE_SERVER_PROPERTY_DATA_URL : BASE_SERVER_PROPERTY_URL + DATA_PATH,

    BASE_SERVER_INSTANCE_URL : BASE_SERVER_URL + INSTANCE_PATH,
    BASE_SERVER_INSTANCE_DATA_URL : BASE_SERVER_INSTANCE_URL + DATA_PATH,

    NULL_DATA : BASE_SERVER_CLASS_DATA_URL + "NULL",
    NULL_TREE_DATA : BASE_SERVER_CLASS_DATA_URL + "NULL?extjs_json_format:tree",

    CLASS_LIST_DATA_URL : BASE_SERVER_URL + "class_list",
    PROPERTY_LIST_DATA_URL : BASE_SERVER_URL + "property_list",
    INSTANCE_LIST_DATA_URL : BASE_SERVER_URL + "instance_list",
